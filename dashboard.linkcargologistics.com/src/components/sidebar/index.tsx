    ...
    <>
      ...
      >
        ...
        <div className={`mx-[46px] mt-[50px] flex items-center`}>
          <Link href="/dashboard" className="mt-1 ml-1 h-2.5 font-poppins text-[20px] font-bold uppercase text-navy-700 dark:text-white">
            {process.env.NEXT_PUBLIC_NAME} <span className="font-medium">{process.env.NEXT_PUBLIC_NAME2}</span>
          </Link>
        </div>
