    ...
    >
      <div className="h-full w-full">
        <div className="relative w-full">
          <Image src={image! as string} className="mb-3 h-full w-full rounded-xl 3xl:h-full 3xl:w-full" alt="" width={200} height={200}/>
          <button
        ...
        <div className="mb-3 flex items-center justify-between px-1 md:flex-col md:items-start lg:flex-row lg:justify-between xl:flex-col xl:items-start 3xl:flex-row 3xl:justify-between">
          ...
          <div className="flex flex-row-reverse md:mt-2 lg:mt-0">
            ...
            {bidders!.map((avt, key) => (
              ...
              >
                <Image className="h-full w-full rounded-full object-cover" src={avt} alt={process.env.NEXT_PUBLIC_NAME||""} width={200} height={100}/>                
              </span>
            ))}
          </div>
        </div>
