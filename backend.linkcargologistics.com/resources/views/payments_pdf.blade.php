...
<body>
    <div class="container">
        ...
        <table class="details-table">
            ...
            <tbody>
                ...
                @foreach ($sale->payments as $payment)
                    <tr>
                        ...
                        <td>{{ $payment->paying_method ?? 'N/A' }}</td>
            ...
            <tfoot>
                <tr>
                    <td colspan="3" class="totals">Monto Venta</td>
                    <td>
                        <div style="text-align: right">
                ...
                <tr>
                    <td colspan="3" class="totals">Total pagado</td>
                    <td>
                        <div style="text-align: right">
                ...
                <tr>
                    <td colspan="3" class="totals">Restante</td>
                    <td>
                        <div style="text-align: right">
                            ${{ number_format(($totalItems - $sale->total_discount + ($sale->shipping_cost??0))-$totalPayments, 2) }}
                        </div>
                    </td>
                </tr>
            </tfoot>
